...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jegut87-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jegut87"
  #   chef.validation_client_name = "jegut87-validator"
  #   chef.validation_key_path = ".chef/jegut87-validator.pem"
  # end
end
